...
DATASETS = {'question answering':
            ...
            [
                ...
                'billsum',
                'cnn_dailymail',
                'covid19sum',#manual download
                'gigaword',
                'multi_news',
                'newsroom', #manual
                'opinion_abstracts/rotten_tomatoes',
            ...
            [
                ...
                'ted_hrlr_translate',
                'ted_multi_translate',
                'wmt14_translate',#manual
                'wmt15_translate',#manual
                'wmt16_translate',#manual
                'wmt17_translate',#manual
                'wmt18_translate',#manual
                'wmt19_translate',#manual
                'wmt_t2t_translate',#manual
            ]
...
def load_dataset(name_dataset):
    ...
    for i in range(len(ls)):
        if ls[i] == 'test':
            #ds[i] = ds[i].batch(64)
            ds_dic[ ls[i] ] = ds[i] #ds[i].prefetch(tf.data.experimental.AUTOTUNE)
